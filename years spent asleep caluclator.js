...
function yearsSpentSleeping( age, avg){
    const hrsin1yr = 8760; 
    const daysin1yr = 365;
    
    const hrsslptin1yr = avg * daysin1yr;
    const tthrsslpt = age * hrsslptin1yr;

    return Math.round(tthrsslpt / hrsin1yr) 
}
console.log(yearsSpentSleeping(5,22));